...
setGeneric("knnCMA", function(X, y, f, learnind, ...)
...
knnCMA(as.matrix(X), y=y, learnind=learnind,...)})
...
setMethod("knnCMA", signature(X="ExpressionSet", y="character", f="missing"),
          ...
          knnCMA(X=X, y=y, learnind=learnind, ...)})